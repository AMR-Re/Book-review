    ...
    <div class="row justify-content-center d-flex mt-5">
        <div class="col-md-12">
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    @if($book->image != '')
                                <img src="{{asset('uploads/book/thumb/'.$book->image)}}" alt="" style="height:350px;" class="card-img-top"></a>
                             @else
                            ...
                            <div class="card border-0 shadow-lg">
                             ...
                             <img src="{{"https://placehold.co/990x1400?text= No Image"}}" alt="" class="card-img-top"></a>
                                ...
                                if($related->reviews_count > 0)
                                    {
                                    $avgRating=$related->reviews_sum_rating/$related->reviews_count;
                                    }
                                    else{
                                        $avgRating=0;
                                    }
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="star-rating d-inline-flex ml-2" title="">
                                        ...
                                        <span class="theme-font text-muted">({{($related->reviews_count > 1) ? $related->reviews_count.' Reviews':$related->reviews_count.' Review' }})</span>
                                    </div>
                                </div>
                            </div>
                        </div>
